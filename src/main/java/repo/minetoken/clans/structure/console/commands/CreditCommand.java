package repo.minetoken.clans.structure.console.commands;
...
public class CreditCommand implements CommandExecutor {
    ...
    public CreditCommand(EconomyManager economyManager) {
        ...
        if (args.length > 1) {
            ...
            if (economyManager.cPlayer.checkExists(economyManager.cPlayer.getUUID(name)) == Result.TRUE) {
                ...
                if(isInt(sAmount)) {
                    ...
                    economyManager.cEco.addCredits(uuid, amount);
                } else {
    ...
    public void help(CommandSender commandSender) {
        ...
        commandSender.sendMessage(Format.info("/givecredits {player} {amount}"));
    }
